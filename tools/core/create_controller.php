...
foreach ($all as $row){
    ...
    $string .="\t\tarray(
            ...
            return anchor('$table_name/read/'.\$d,'<i class=\"fa fa-eye\"></i>',\"class='btn btn-sm btn-primary'\").' '.
                   anchor('$table_name/update/'.\$d,'<i class=\"fa fa-edit\"></i>',\"class='btn btn-sm btn-warning'\").' '.
                   anchor('$table_name/delete/'.\$d,'<i class=\"fa fa-trash\"></i>',\"class='btn btn-sm btn-danger'\");
                }
            )
        );
        ...
        \$this->load->library('Ssp');  // beware of this filename
        echo json_encode(
...
/* Please DO NOT modify if you not understand what is it ! */
/* This File Automatically Generated by Our System at ".date('Y-m-d H:i:s')." */
/* http://".$title." */";

        ...
        <div class="row">
            <div class="col-md-3">
                <form action="index.php" method="POST">
                    ...
                    <div class="form-group    "target": "' . $target . '",
                    "co">
                        <label>Select Tabl    "target": "' . $target . '",
                    "coe - <a href="<?php echo $_SERVER['PHP_SELF'] ?>">Refresh</a></label>
                        <select id="table_    "target": "' . $target . '",
                    "coname" name="table_name" class="form-control" onchange="setname()">

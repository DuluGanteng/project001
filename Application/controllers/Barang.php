    ...
    function data() {
		...
		array(
                ...
                'formatter' => function( $d, $row ) {
                    $buttons  = '<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal1"><i class="fa fa-eye"></i></button> ';
                    $buttons .= anchor('barang/update/'.$d,'<i class="fa fa-edit"></i>',"class='btn btn-sm btn-warning'").' ';
                    $buttons .= anchor('barang/delete/'.$d,'<i class="fa fa-trash"></i>',"class='btn btn-sm btn-danger'");
            return  $buttons; 
                }
            )
        );
...
/* Generated by HCC Generator at 2018-09-20 14:47:22 */
/* http://www.mysite.com */